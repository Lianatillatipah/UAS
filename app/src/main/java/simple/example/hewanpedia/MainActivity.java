...
public class MainActivity extends AppCompatActivity {
    ...
    private void inisialisasiView() {
        ...
        btnKucing.setOnClickListener(view -> bukaGaleri("Buah"));
        btnAnjing.setOnClickListener(view -> bukaGaleri("Sayuran"));
        btnBuaya.setOnClickListener(view -> bukaGaleri("Makanan"));
