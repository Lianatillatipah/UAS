...
public class ProfilActivity extends AppCompatActivity {
    ...
    private void tampilkanProfil(Hewan hewan) {
        ...
        if(hewan  instanceof Buah){
            txJudul.setText(getString(R.string.Buah));
        } else if (hewan  instanceof Sayuran){
            txJudul.setText(getString(R.string.Sayuran));
        } else if (hewan  instanceof Makanan){
            txJudul.setText(getString(R.string.Makanan));
        }
